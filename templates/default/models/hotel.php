            ...
            <div class="container">
                <div class="row">
                    <div class="boxed">
                                 ...
                                 <?php if(LANG_ENABLED){  $url_lang_tag="/".LANG_TAG; }else{
                                     $url_lang_tag="";
                                } ?>
                                <div class="row">
                                    <div class="col-sm-12" style="display: flex; flex-flow: row wrap; justify-content: center;">
                                                                      <div class="col-sm-2">
                                                <a class="btn btn-block btn-primary" href="<?php echo $url_lang_tag ?>/<?php echo basename($page_alias)  ?>-overview"> <?php echo $texts['hotel_overview'] ?> </a>

                                            </div>
                                            <div class="col-sm-2">
                                                <a class="btn btn-block btn-primary" href="<?php echo $url_lang_tag ?>/<?php echo basename($page_alias)  ?>-accommodation"><?php echo $texts['hotel_accommodation'] ?> </a>

                                            </div>
                                            <div class="col-sm-2">
                                                <a class="btn btn-block btn-primary" href="<?php echo $url_lang_tag ?>/<?php echo basename($page_alias)  ?>-dining"><?php echo $texts['hotel_dining']  ?> </a>

                                            </div>

                                            
                                            <div class="col-sm-2">
                                                <a class="btn btn-block btn-primary" href="<?php echo $url_lang_tag ?>/<?php echo basename($page_alias)  ?>-gallery"><?php echo $texts['hotel_gallery'] ?></a>

                                            </div>
                                           
                                            <div class="col-sm-2">
                                                <a class="btn btn-block btn-primary" href="<?php echo $url_lang_tag ?>/<?php echo basename($page_alias)  ?>-downloads"><?php echo $texts['hotel_downloads'] ?></a>
