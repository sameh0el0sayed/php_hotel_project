...
if(!isset($_SESSION['meal_name'])){
    $_SESSION['meal_name']='null_meal';
}
                ...
                <div class="col-12" style="display: flex; flex-flow: row wrap; justify-content: center;">
                        ...
                        <?php
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="form-group">
                                        <div class="input-group">
                                        <div class="input-group-addon"><?php echo $texts['MEAL_PLAN']; ?></div>

                                            <select name="meal_name" class="selectpicker form-control">
                                                <?php
                                                    $selected_null_meal=  $_SESSION['meal_name']=='null_meal' ?' selected="selected"' : '';
                                                    $selected_breakfast_meal=  $_SESSION['meal_name']=='breakfast_meal' ?' selected="selected"' : '';
                                                    $selected_half_board_meal=  $_SESSION['meal_name']=='half_board_meal' ?' selected="selected"' : '';
                                                    $selected_full_board_meal=  $_SESSION['meal_name']=='full_board_meal' ?' selected="selected"' : '';
                                                    $selected_soft_inclusive_meal=  $_SESSION['meal_name']=='soft_inclusive_meal' ?' selected="selected"' : '';
                                                    $selected_all_inclusive_meal=  $_SESSION['meal_name']=='all_inclusive_meal' ?' selected="selected"' : '';
                                                ?> 
                                                <option value="null_meal" <?php echo $selected_null_meal ?> ><?php echo $texts['null_meal']; ?></option>
                                                <option value="breakfast_meal" <?php echo $selected_breakfast_meal ?> ><?php echo $texts['breakfast_meal']; ?></option>
                                                <option value="half_board_meal" <?php echo $selected_half_board_meal ?> ><?php echo $texts['half_board_meal']; ?></option>
                                                <option value="soft_inclusive_meal" <?php echo $selected_soft_inclusive_meal ?> ><?php echo $texts['soft_inclusive_meal']; ?></option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            <div class="col-md-4 col-sm-6 col-xs-12">
                                <button class="btn btn-block btn-primary" type="submit" name="check_availabilities"><?php echo $texts['search_go']; ?></button>
