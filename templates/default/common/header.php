...
<head>
    ...
    <link rel="stylesheet" href="templates/default/css/bootstrap-select.min.css">
    <link rel="stylesheet" href="templates/default/css/magnific-popup.min.css"> -->
    <link rel="stylesheet" href="<?php echo getFromTemplate('css/jquery-ui.min.css'); ?>"> 
    <link rel="stylesheet" href="<?php echo getFromTemplate('css/bootstrap-select.min.css'); ?>"> 
    <link rel="stylesheet" href="<?php echo getFromTemplate('css/magnific-popup.min.css'); ?>">
    ...
    <script src="<?php echo getFromTemplate('sr_slider_assets/js/owl.carousel.min.js'); ?>"></script>  


    <!-- <script src="/templates/default/sr_slider_assets/js/owl.carousel.min.js"></script> -->
...
<header class="navbar-fixed-top fixed">
                            ...
                            foreach($menu as $nav_id => $nav){
                                if($nav['id_parent'] == $id_parent){ ?>
                                    <li>
                                        ...
                                        <a class="<?php if($hasChildNav) echo 'hasSubMenu'; ?> cls_edit_url_manu" href="<?php echo $nav['href']; ?>" target="<?php echo $nav['target']; ?>" title="<?php echo $nav['title']; ?>"><?php echo $nav['name']; ?></a>
    ...
    <script type="text/javascript">
        var lang_enable = '<?php echo LANG_ENABLED; ?>';
        var lang_tag = '/<?php echo LANG_TAG; ?>';
         console.log(lang_enable);
         console.log(lang_tag); 

        if(lang_enable==1){

                var cls_edit_url_manu_search = document.getElementsByClassName('cls_edit_url_manu');
                if (cls_edit_url_manu_search.length > 0) {
                    
                    $('.cls_edit_url_manu').each(function(i) {
                     
                        var copy_href= $(this).attr("href");
                        $(this).attr("href",lang_tag + copy_href);
                ...
                $(document).ready(function($) {
                    var cls_edit_url_btn_search = document.getElementsByClassName('cls_edit_url_btn');

                    if (cls_edit_url_btn_search.length > 0) {
                        
                        $('.cls_edit_url_btn').each(function(i) {
